...
import net.dannykandmichaelk.firstmod.util.biome.GeneratorUtil;
...
public class EvergreenTreeFeature extends GeneralTreeFeature<EvergreenTreeConfiguration> {



    public EvergreenTreeFeature(Codec<EvergreenTreeConfiguration> codec)
    {
        super(codec);
    }
