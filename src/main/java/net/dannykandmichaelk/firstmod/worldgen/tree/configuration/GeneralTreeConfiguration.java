package net.dannykandmichaelk.firstmod.worldgen.tree.configuration;
...
public class GeneralTreeConfiguration extends TreeConfiguration {

    public static final Codec<GeneralTreeConfiguration> CODEC = RecordCodecBuilder.create((builder) -> {
        ...
        ).apply(builder, GeneralTreeConfiguration::new);
    });
    ...
    protected GeneralTreeConfiguration(BlockStateProvider trunkProvider, BlockStateProvider foliageProvider, BlockStateProvider vineProvider, BlockStateProvider hangingProvider, BlockStateProvider trunkFruitProvider, BlockStateProvider altFoliageProvider, int minHeight, int maxHeight, List<TreeDecorator> decorators)
    {
    ...
    public static class Builder<T extends Builder>
    {
        ...
        public GeneralTreeConfiguration build()
        {
            return new GeneralTreeConfiguration(this.trunkProvider, this.foliageProvider, this.vineProvider, this.hangingProvider, this.trunkFruitProvider, this.altFoliageProvider, this.minHeight, this.maxHeight, this.decorators);
        }
    }
}
