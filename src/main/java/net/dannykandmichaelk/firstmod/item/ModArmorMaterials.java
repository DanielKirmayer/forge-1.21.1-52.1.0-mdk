...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> CRYONITE_ARMOR_MATERIAL = register("cryonite", Util.make(new EnumMap<>(ArmorItem.Type.class),
            attribute -> {
            ...
            }), 100, 4f, 0.1f, () -> ModItems.CRYONITE.get());
