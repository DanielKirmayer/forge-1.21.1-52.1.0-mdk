...
import net.dannykandmichaelk.firstmod.component.ModDataComponentTypes;

public class ModItemProperties {
    public static void addCustomItemProperties() {
        ItemProperties.register(ModItems.SUPER_CHISEL.get(), ResourceLocation.fromNamespaceAndPath(FirstMod.MOD_ID, "used"),
